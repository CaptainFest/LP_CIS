...
from transformers import TrOCRProcessor, VisionEncoderDecoderModel, default_data_collator, \
                         Seq2SeqTrainer, Seq2SeqTrainingArguments, XLMRobertaTokenizer, BeitImageProcessor, \
...
def model_init(trial):
    ...
    "microsoft/beit-base-patch16-224-pt22k", "blinoff/roberta-base-russian-v0"
    )
...
if __name__ == '__main__':
    ...
    processor = TrOCRProcessor(image_processor=ViTImageProcessor(),
    ...
    for key in dict_ocr_folders:
        ...
        training_args = Seq2SeqTrainingArguments(
            output_dir=f'exps/aug__beit_xlmroberta_224_{key}',
